        ...
        <div className="mt-16 px-6 md:px-12 lg:px-24 max-w-4xl mx-auto">
            ...
            <ul className="space-y-6">
                <li className="bg-white rounded-lg shadow-lg p-6 transition-transform transform hover:-translate-y-2 hover:shadow-xl">
                    <h3 className="text-2xl font-semibold text-indigo-500">Banglamed.net(May 2020 - December 2021)</h3>
                ...
                <li className="bg-white rounded-lg shadow-lg p-6 transition-transform transform hover:-translate-y-2 hover:shadow-xl">
                    <h3 className="text-2xl font-semibold text-indigo-500">stock.banglamed.net(January 2022 - January 2024)</h3>
                    <p className="text-gray-600 mt-2">
                ...
                <li className="bg-white rounded-lg shadow-lg p-6 transition-transform transform hover:-translate-y-2 hover:shadow-xl">
                    <h3 className="text-2xl font-semibold text-indigo-500">Genesis</h3>
                    <p className="text-gray-600 mt-2">
                        A educational site where doctor can enroll course and can do class with Laravel, Vue.js, and Tailwind CSS, Bootstrap.
                    </p>
                </li>
            </ul>
        </div>
